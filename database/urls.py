...
urlpatterns = patterns('',
	...
	url(r'shopping/$', 'database.views.shopping', name='shopping'),
	url(r'providers/$', 'database.views.providers', name='providers'),
	url(r'brands/$', 'database.views.brands', name='brands'),
	url(r'organizations/$', 'database.views.organizations', name='organizations'),
	url(r'appliances/$', 'database.views.appliances', name='appliances'),
	url(r'percentages/$', 'database.views.percentages', name='percentages'),
